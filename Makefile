...
#     AUTHOR => [q[Marcus Ramberg <mramberg@cpan.org>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     NAME => q[Mojolicious::Plugin::RenderSteps]
#     PREREQ_PM => { Mojolicious=>q[4.99] }
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/Mojolicious/Plugin/RenderSteps.pm]
#     test => { TESTS=>q[t/*.t] }
...
MAKE = make
FULLEXT = Mojolicious/Plugin/RenderSteps
BASEEXT = RenderSteps
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Mojolicious/Plugin/RenderSteps.pm
...
TO_INST_PM = lib/Mojolicious/Plugin/RenderSteps.pm

PM_TO_BLIB = lib/Mojolicious/Plugin/RenderSteps.pm \
...
DISTVNAME = Mojolicious-Plugin-RenderSteps-0.01
...
manifypods : pure_all  \
	lib/Mojolicious/Plugin/RenderSteps.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Mojolicious/Plugin/RenderSteps.pm $(INST_MAN3DIR)/Mojolicious::Plugin::RenderSteps.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Mojolicious-Plugin-RenderSteps",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '         "requires" : {' >> META_new.json
	$(NOECHO) $(ECHO) '            "Mojolicious" : "4.99"' >> META_new.json
	$(NOECHO) $(ECHO) '         }' >> META_new.json
	$(NOECHO) $(ECHO) '      }' >> META_new.json
	$(NOECHO) $(ECHO) '   },' >> META_new.json
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Mojolicious/Plugin/RenderSteps.pm blib/lib/Mojolicious/Plugin/RenderSteps.pm 
